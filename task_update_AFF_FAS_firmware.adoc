...
---
= Descargue el paquete de firmware Ansible AFF y FAS de Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.Pasos
. Selecciona cualquier widget de bienestar en el panel de control o selecciona *Ver todas las acciones* para ver una lista de todas las acciones y riesgos.
. Selecciona *Actualización de firmware* para ver todos los riesgos de actualización de firmware.
. Selecciona *Update AFF and FAS Firmware* para ver todos los paquetes de actualización disponibles o selecciona image:update_ansible.png["Actualice Ansible"] junto a cada riesgo para actualizar el paquete específico de ese riesgo.
. Selecciona *Descargar* para descargar los archivos zip y actualizar tu sistema de almacenamiento.
+
