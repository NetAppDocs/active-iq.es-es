...
summary: Descubre las nuevas funciones y mejoras en Digital Advisor. 
---
...
* La función Tech Refresh ahora se llama System Refresh. Aprende a link:https://docs.netapp.com/us-en/active-iq/evaluate-tech-refresh.html["evaluar una actualización del sistema"].
...
La sostenibilidad ahora es compatible con los sistemas E-Series y StorageGRID .  Puede ver una lista de acciones recomendadas e indicadores ambientales que muestran proyecciones de energía, uso directo de carbono y calor desde el panel de sustentabilidad de estos sistemas. Para obtener más información, consultelink:https://docs.netapp.com/us-en/active-iq/sustainability-dashboard-overview.html["Información general del panel de sostenibilidad"^] .
...
* El flujo de trabajo de Wellness ahora incluye el widget Sustainability, que muestra el recuento de acciones recomendadas a nivel de cliente, lista de seguimiento, sitio y grupo. Puedes seleccionar el número de acciones para ver en detalle estas acciones recomendadas en el panel de Sustainability. Para obtener más información, consulta link:https://docs.netapp.com/us-en/active-iq/learn-about-sustainability.html["Analice la sostenibilidad de sus sistemas de almacenamiento"].
...
* El botón *Ahorro sin copias de backup de instantáneas* ahora se llama *Con copias de instantáneas* junto con un cambio en su funcionalidad. link:https://docs.netapp.com/us-en/active-iq/reference_aiq_faq.html#storage-efficiency["Leer más"].
...
El panel de sostenibilidad proporciona información valiosa sobre la sostenibilidad ambiental de su sistema de almacenamiento.  Puede ver información como la puntuación de sostenibilidad, el porcentaje de mitigación de carbono, el uso proyectado de energía, el carbono directo y el calor.  Puede ajustar el porcentaje de mitigación de carbono para sitios específicos.  También puede ver la puntuación de sostenibilidad a nivel de clúster.  Según la puntuación de sostenibilidad, puede evaluar la eficiencia general de su sistema de almacenamiento y alinearlo con las acciones recomendadas de NetApp para mejorar la sostenibilidad. link:https://docs.netapp.com/us-en/active-iq/learn-about-sustainability.html["Leer más"] .
...
La eficiencia de almacenamiento SAN y NAS está disponible, a nivel de nodo, para los sistemas ONTAP, incluyendo AFF A-Series, AFF C190, All SAN Array y FAS500.
...
=== Digital Advisor se integra con NetApp Console

Active IQ Digital Advisor ahora se llama Digital Advisor y está integrado en NetApp Console, la consola de gestión unificada de NetApp para entornos híbridos multinube. link:https://docs.netapp.com/us-en/active-iq/digital-advisor-integration-with-console.html["Leer más"].
...
NetApp Console ahora permite a los usuarios abrir enlaces de Digital Advisor en nuevas pestañas, siempre que sea aplicable, igual que la funcionalidad existente en Digital Advisor.
...
* En el correo electrónico «Wellness Review», encontrarás información sobre Ransomware Defense en lugar de Renewals.
...
Al seleccionar la casilla azul «Resumen de volúmenes» en la tabla SVM, aparece una ventana emergente con información detallada sobre los volúmenes alojados o asociados a ese número de serie o nodo físico concreto.
...
* *Widget de planificación:*
+
** *Ampliaciones de capacidad:* Si algún sitio de GRID supera el umbral del 70 % de la capacidad existente, se te notificará. Tienes la opción de añadir capacidad para los StorageGRIDs en el sitio, para los próximos 1, 3 y 6 meses si es probable que el umbral de capacidad supere el 70 %.
** *Renovaciones:* Para cualquier sistema StorageGRID cuyo contrato de licencia haya caducado o esté por caducar en los próximos 6 meses, se te notificará. Puedes seleccionar uno o más sistemas para enviar una solicitud al equipo de soporte de NetApp para la renovación.
...
* *Visor de GRID:* Desde el widget *Configuración*, puedes consultar la configuración de GRID en detalle seleccionando el enlace *Visor de GRID*. Desde el widget *Configuración*, puedes descargar los detalles del sitio y los detalles de capacidad del StorageGRID seleccionado pulsando el botón *Descargar* en la pantalla *Visor de GRID*.
...
* *Resumen de GRID:* Contiene información básica, como el tipo de licencia, la capacidad de la licencia, el número de nodos instalados, el plazo de asistencia técnica (fecha de finalización del contrato de licencia), el nodo de administración principal y la ubicación principal de dicho nodo. Esta pestaña también muestra el nombre de la ubicación y el número de nodos de almacenamiento asociados a la ubicación correspondiente. En esta versión, puedes ver la lista de nombres de nodos al seleccionar el enlace disponible para visualizar los nodos de almacenamiento del sitio correspondiente.
...
Se ha añadido el botón Tier Data al panel de control de FabricPool, y te permite clasificar datos en niveles de almacenamiento de objetos de bajo coste usando NetApp Console.
...
Puedes utilizar las API de Digital Advisor para extraer los datos que te interesen e integrarlos directamente en el flujo de trabajo de tu empresa. link:https://docs.netapp.com/us-en/active-iq/concept_overview_API_service.html["Leer más"].
...
Puedes ver la relación de eficiencia del almacenamiento y el ahorro de tu sistema de almacenamiento con y sin copias snapshot para sistemas AFF, sistemas que no son AFF o ambos. Puedes ver la información de eficiencia del almacenamiento a nivel de nodo. link:https://docs.netapp.com/us-en/active-iq/task_analyze_storage_efficiency.html["Vea cómo"].
