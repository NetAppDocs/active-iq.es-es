...
* El flujo de trabajo de Bienestar ahora incluye el widget de Sustentabilidad, que proporciona el recuento de acciones recomendadas a nivel de cliente, lista de seguimiento, sitio y grupo.  Puede hacer clic en el número de acciones para obtener una vista detallada de estas acciones recomendadas en el panel de Sustentabilidad. Para obtener más información, consultelink:https://docs.netapp.com/us-en/active-iq/learn-about-sustainability.html["Analice la sostenibilidad de sus sistemas de almacenamiento"] .
...
Al hacer clic en el recuadro azul «Resumen de volúmenes» de la tabla SVM, aparece una ventana emergente con información detallada sobre los volúmenes que están alojados o asociados al número de serie o nodo físico específico.
