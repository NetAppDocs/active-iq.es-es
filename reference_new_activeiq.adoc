...
Active IQ Digital Advisor se está cambiando a Digital Advisor y ahora está integrado en BlueXP, la consola de administración unificada de NetApp para entornos multicloud híbridos. link:https://docs.netapp.com/us-en/active-iq/digital-advisor-integration-with-console.html["Leer más"] .
...
* *Widget de planificación:*
+
** *Adiciones de capacidad:* Para cualquier sitio GRID que supere el umbral del 70% de la capacidad existente, se te notificará. Tienes la opción de añadir capacidad para los StorageGRIDs en el sitio, para los próximos 1, 3 y 6 meses si es probable que el umbral de capacidad supere el 70%.
