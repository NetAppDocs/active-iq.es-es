...
. Selecciona *Acciones* en el widget *Security & Ransomware Defense*. image:Security_Image 2 Ransomware attacks.png["Widget vulnerabilidades de seguridad"]
...
. Selecciona la pestaña *Riesgos específicos* y luego selecciona el enlace en la columna *Medida correctiva*. image:Corrective Action_Image 2 Ransomware attacks.png["Columna Acción correctiva"]
+
