...
---
= Visualice el estado de los clústeres y nodos mediante el widget ClusterViewer en Digitial Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
. A nivel de clúster o de nodo, selecciona *ClusterViewer* junto al widget *Configuración*.
. Selecciona la pestaña *Visualización* para ver una representación gráfica del clúster.
