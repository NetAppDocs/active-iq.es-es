...
.Pasos
. En el panel de la izquierda, selecciona *Reports*.
. Selecciona *Crear informe* para generar un nuevo informe.
+
...
NOTE: El informe se guarda en Digital Advisor durante 3 meses.
 a| 
