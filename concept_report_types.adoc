...
| Resumen ejecutivo de evaluación de la salud | Ofrece información sobre varios KPI de Digital Advisor en formato PowerPoint (PPT), con diferentes KPI descritos en distintas diapositivas. | Sí | Sí | No 
...
| Seguridad | Proporciona una visión general completa y exportable de los riesgos de seguridad del almacenamiento de ONTAP y las brechas de cumplimiento en clústeres, SVMs y volúmenes. | Sí | No | No 
