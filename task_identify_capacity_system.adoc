...
.Pasos
. En el widget *Planificación*, haz clic en *Ampliación de almacenamiento*.
+
...
. Haz clic en *Enviar* para enviar la solicitud al equipo de almacenamiento de NetApp para que te ayude con la ampliación del almacenamiento de los sistemas seleccionados.
