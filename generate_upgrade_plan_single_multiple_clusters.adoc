...
* Asegúrese de que AutoSupport (ASUP) esté habilitado y configurado correctamente, y que todas las secciones necesarias estén incluidas. Para obtener más información, consulte link:hhttps://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/ONTAP_AutoSupport_Resolution_Guide["Guía de resolución de problemas de AutoSupport de ONTAP"].
