...
---
= Conozca las funciones del panel de sustentabilidad en Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
*Porcentajes de reducción de emisiones de carbono*: Muestra el porcentaje de reducción de emisiones de carbono en cada lugar o ciudad, y los valores de referencia que se muestran se basan en tu ubicación. Puedes ajustar el porcentaje de reducción de emisiones de carbono para lugares concretos seleccionando el icono image:edit_icon_1.png["Una captura de pantalla que muestra un icono editable."] situado junto a los valores porcentuales, y las cifras de emisiones de carbono se ajustarán automáticamente en consecuencia.
