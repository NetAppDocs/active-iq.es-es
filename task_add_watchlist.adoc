...
---
= Crear una lista de seguimiento en Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Puede crear una lista de seguimiento para acceder a un conjunto de sistemas de almacenamiento de forma rápida y sencilla. Puede agregar los sistemas de almacenamiento según la categoría o el número de serie.


NOTE: Puede agregar un máximo de 15.000 sistemas de almacenamiento bajo una categoría y 500 sistemas de almacenamiento bajo un número de serie.
...
. Selecciona *Crear lista de seguimiento*.
. Introduzca un nombre para la lista de observación.
. Seleccione una de las siguientes opciones para agregar sistemas de almacenamiento a la lista de seguimiento:
+
