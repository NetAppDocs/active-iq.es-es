...
* *Adopción de AutoSupport*: Muestra el número y el porcentaje de sistemas con AutoSupport activado. También puedes ver los sistemas marcados como ‘Declined’, los que tienen *HTTPS* y *AutoSupport on Demand* activados, así como *Loss of Signal* para aquellos sistemas que han dejado de enviar datos de AutoSupport en los últimos 7 días. Para ver tu puntuación de revisión de estado e información sobre los sistemas en tu base instalada, haz clic en el widget *AutoSupport Adoption*.
