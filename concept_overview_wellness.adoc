...
[role="lead"]
El widget Wellness proporciona información detallada sobre tu sistema de almacenamiento. Proporciona información sobre distintos atributos de tu sistema de almacenamiento, como el rendimiento y la eficiencia, la capacidad, los ajustes de configuración, las vulnerabilidades de seguridad, las renovaciones de soporte y otros.
