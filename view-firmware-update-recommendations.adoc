...
summary: Consulta las recomendaciones de actualización del firmware de almacenamiento, del firmware de SP y BMC, de los archivos del sistema y de los archivos de seguridad. 
---
