...
* Consulta la tasa de reducción de datos, el espacio lógico utilizado, el espacio físico utilizado y el total de datos guardados.
...
* link:concept_value_insights.html["Descubre información valiosa"], que ofrece información general sobre el estado, el ahorro, la estabilidad y la seguridad de tu sistema ONTAP.
