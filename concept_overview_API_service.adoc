...
Cualquiera de las dos vistas permite al usuario navegar por los elementos disponibles mediante el panel de navegación de la izquierda. Los elementos están organizados por servicio en orden alfabético. Dentro de un servicio determinado, puedes desplegar el encabezado para mostrar los puntos finales de la API individuales. Al seleccionar el encabezado del servicio o un punto final de la API, accederás a esa sección del catálogo en el panel central.
...
Para obtener información sobre cómo acceder y usar las API de Digital Advisor, consulta link:https://docs.netapp.com/us-en/digital-advisor-automation/["NetApp Digital Advisor documentación de la API"].
