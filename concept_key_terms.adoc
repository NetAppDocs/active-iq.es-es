...
** *Solucionar:* Soluciona los riesgos del sistema mediante Active IQ Unified Manager. Haz clic en este botón para iniciar Unified Manager y realizar los pasos para mitigar los riesgos.
