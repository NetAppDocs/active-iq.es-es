...
---
= Términos y definiciones clave en Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
** *Solucionar:* Soluciona los riesgos del sistema mediante Active IQ Unified Manager. Selecciona este botón para iniciar Unified Manager y realizar los pasos para mitigar los riesgos.
...
* *Widget de planificación:* Muestra información sobre la ampliación del almacenamiento, el software y el hardware que necesita renovarse.
+
** *Ampliación de almacenamiento:* Identifica los sistemas que han superado o se acercan al 90% de su capacidad y los sitios GRID que han superado o se acercan al 70% de su capacidad. Puedes hacer una solicitud para aumentar la capacidad de tu sistema de almacenamiento.
** *Renovaciones de soporte:* Proporciona información sobre el software y el hardware que ha caducado o que está próximo a caducar en los próximos 6 meses.
...
* *Eficiencia de almacenamiento:* Identifica la relación de eficiencia de almacenamiento y el ahorro de tu sistema de almacenamiento con y sin copias snapshot para sistemas AFF, sistemas no AFF o ambos.
...
* *Servicios API:* Te permite extraer los datos que te interesan e integrarlos directamente en el flujo de trabajo de tu empresa.
...
* *Cliente:* Te permite consultar y gestionar la base instalada de clientes. Customer Dashboard es el portal central de Digital Advisor.
